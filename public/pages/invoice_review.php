...
<main class="content-wrapper">
    ...
    <table class="transactions-table">
        <thead>
            <tr>
                <th>ID</th><th>GD#</th><th>Email</th><th>Gói</th><th>Yêu cầu</th><th>Trạng thái</th><th>File</th><th>Lý do</th><th>Thao tác</th>
            </tr>
        </thead>
        <tbody>
                ...
                <td class="actions">
                    <?php if ($inv['status'] === 'pending'): ?>
                        <a href="invoice_upload.php?invoice_id=<?php echo $inv['invoice_id']; ?>">
                            <button type="button">Upload PDF & Approve</button>
                        </a>
                        <button onclick="rejectInvoice(<?php echo $inv['invoice_id']; ?>)">Từ chối</button>
